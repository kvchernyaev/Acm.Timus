...
namespace _22_1922_196
{
    /// <summary>
    /// http://acm.timus.ru/problem.aspx?num=1922
    /// </summary>
    class Program_22_1922_196
    {
        #region console
#if ONLINE_JUDGE
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                List<List<int>> commands = Solve(ar);

                Console.WriteLine(commands.Count);
                foreach (List<int> command in commands)
                    Console.WriteLine("{0} {1}", command.Count, string.Join(" ", command.Select(x => x + 1)));
        ...
        static List<List<int>> Solve(int[] ar)
        {
